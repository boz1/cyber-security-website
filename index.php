...
<head>
    ...
    function focusOnInput() // Focus set to username input
    {
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Victim</strong> Login</h1>
                            <div class="description">
                               <p>
                                  This is a vulnerable website for testing SQL Injection, and
                                  XSS attacks.
                              </p>
                          </div>
                      </div>
               ...
               <div class="form-bottom">
                   <form role="form" action="home.php" method="post" class="login-form">
                    <div class="form-group">
                     ...
                     <input type="text" name="uname" placeholder="Victim name..." class="form-username form-control" id="form-username">
                 </div>
                 <div class="form-group">
                ...
                <button type="submit" class="btn">Be Victim!</button>
            </form>
        </div>
    </div>
    </div>
